	...
	<section id="Article-container" class="max-w-[1130px] mx-auto flex gap-20 mt-[50px]">
		...
		<div class="side-bar flex flex-col w-[300px] shrink-0 gap-10">
			<div class="ads flex flex-col gap-3 w-full">
				<a href="{{$squareBannerads_1->link}}">
					<img src="{{Storage::url($squareBannerads_1->thumbnail)}}" class="object-contain w-full h-full" alt="ads" />
				</a>
				<p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
					Our Advertisement <a href="{{$squareBannerads_1->link}}" class="w-[18px] h-[18px]"><img
			...
			<div class="ads flex flex-col gap-3 w-full">
				<a href="{{$squareBannerads_2->link}}">
					<img src="{{Storage::url($squareBannerads_2->thumbnail)}}" class="object-contain w-full h-full" alt="ads" />
				</a>
				<p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
					Our Advertisement <a href="{{$squareBannerads_2->link}}" class="w-[18px] h-[18px]"><img
							src="{{asset('assets/images/icons/message-question.svg')}}" alt="icon" /></a>
				</p>
			</div>
		</div>
